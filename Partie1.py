...
"""data=[[170,250,1145,7.5,25190,124,4,3],#alfa
     ...
     [207,280,1218,6.8,25800,174,3,5],#OpelOPC
     [208,300,1160,6.5, 25800,125,4,3],#peugot
     [208,300,1160,6.5,29200,125,4,5],#peugotSp
     [120,190,1090,9.4,22370,120,3,3],#renGT
     [200,240,1204,6.7,25850,133,3,4],#renRS
     [220,280,1204,6.6,28900,135,3,4],#renRST
     [110,175,1027,9.1,18165,119,U,U],#seatFR
     [192,320,1269,6.7,22690,139,U,U],#seatCh
     [136,160,1040,8.7,15680,147,3,5],#Suzuki
     [150,250,1212,7.9,23140,110,4,3],#VWB
     [192,320,1269,6.7,26390,139,4,3]#VWGTI
     ]"""
